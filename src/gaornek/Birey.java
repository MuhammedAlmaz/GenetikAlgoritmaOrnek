...
public class Birey {
	...
	//Virgülden sonra ilk 10 karakterlik hassasiyette arayacaðýz sistemi.
	//Tüm onluk parçalardaki birlerin toplamý , o an ki sayý deðerini verecek.
    ...
    public String toString() {
		//geni okumak için ihtiyacýmýz var
        String genDizilimi = "";
        for (int i = 0; i < Baslangic.genAdedi; i++) {
